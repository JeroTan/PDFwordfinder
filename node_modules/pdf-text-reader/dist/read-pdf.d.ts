import type { BinaryData, DocumentInitParameters, PDFPageProxy, TextItem } from 'pdfjs-dist/types/src/display/api';
 ...
 */
export declare function readPdfPages({ data, filePath, password, pathToPdfJsDistNodeModule, progressCallback, url, }: ReadPdfTextParams): Promise<PdfPage[]>;
